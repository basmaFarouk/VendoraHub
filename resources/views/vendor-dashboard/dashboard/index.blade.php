...
@section('contents')
    <div class="container-xl">
        @if(auth('web')->user()->kyc?->status == App\Enums\KycStatus::Pending)
        ...
        @if(auth('web')->user()->kyc?->status == App\Enums\KycStatus::Rejected || auth('web')->user()->kyc == null)
            <div class="alert alert-important alert-danger alert-dismissible" role="alert">
                ...
                <div class="w-100">
                    ...
                    <div class="alert-description d-flex justify-content-between align-items-center">
                        <ul class="alert-list">
                            <li>Please Submit your kyc to get Started</li>
                        </ul>
                        <div>
                            <a href="{{ route('kyc.index') }}" class="btn btn-6 btn-light active btn-pill"> Submit Kyc</a>
                        </div>
                    </div>
                </div>
                <a class="btn-close" data-bs-dismiss="alert" aria-label="close"></a>
