        ...
        <div class="card card-md">
          <div class="card-body">
            <h2 class="h2 text-center mb-4">Reset Your Password</h2>
                <!-- Session Status -->
                <form action="{{ route('admin.password.store') }}" method="POST" autocomplete="off">
                    @csrf
            ...
            <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" name="password_confirmation" class="form-control" placeholder="Your password" autocomplete="new-password" />
